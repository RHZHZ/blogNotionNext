...
export default function WavesArea() {
  ...
  return (
    <section className='main-hero-waves-area pointer-events-none absolute bottom-0 left-0 z-10 w-full opacity-65 md:opacity-55'>
      <svg
        className='waves-svg h-[32px] w-full md:h-[44px]'
