...
const Logo = props => {
  ...
  return (
    <SmartLink href='/' passHref legacyBehavior>
      <div className='heo-brand-mark flex flex-nowrap items-center cursor-pointer font-extrabold'>
        <div className='heo-brand-mark__icon flex items-center'>
          <LazyImage
            src={siteInfo?.icon}
            width={24}
            height={24}
        ...
        <div className='heo-brand-mark__text flex items-center'>
