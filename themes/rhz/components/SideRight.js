...
export default function SideRight(props) {
  ...
  return (
    <div id='sideRight' className='hidden xl:block h-full w-72 space-y-4'>
      ...
      <div className='rhz-side-right-sticky heo-side-right-sticky sticky top-20 space-y-4'>
        {post && post.toc && post.toc.length > 0 && (
          <Card className='rhz-card--interactive heo-card--interactive rhz-toc-card heo-toc-card wow fadeInUp rounded-[1.75rem] border p-4 backdrop-blur-xl'>
            <div className='rhz-toc-card__header heo-toc-card__header mb-3 px-1'>
              <div style={sectionLabelStyle} className='rhz-toc-card__eyebrow heo-toc-card__eyebrow text-[11px] font-semibold uppercase tracking-[0.24em]'>
                Article
              </div>
              <div style={sectionTitleStyle} className='rhz-toc-card__title heo-toc-card__title mt-1 text-lg font-semibold'>
        ...
        <Card className='rhz-card--interactive heo-card--interactive wow fadeInUp hidden rounded-[1.75rem] border p-4 backdrop-blur-xl lg:block'>
          <div className='mb-3 px-1'>
            <div style={sectionLabelStyle} className='text-[11px] font-semibold uppercase tracking-[0.24em]'>
              Feed
            </div>
        ...
        <Card className='rhz-card--interactive heo-card--interactive wow fadeInUp rounded-[1.75rem] border p-4 backdrop-blur-xl'>
          ...
          <div style={subSectionStyle} className='rounded-[1.35rem] border px-3 py-3 backdrop-blur-sm'>
            <div className='mb-3 px-1'>
              <div style={subSectionLabelStyle} className='text-[10px] font-semibold uppercase tracking-[0.22em]'>
                Browse
              </div>
