...
export default function PostHeader({ post, siteInfo, isDarkMode }) {
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--rhz-cover-color', headerBgColor)
    root.style.setProperty('--rhz-cover-shadow-color', coverShadowColor)

    window.dispatchEvent(
      new CustomEvent('rhz-cover-color-change', {
