    ...
    <style jsx global>{`
        ...
        :root {
           ...
           --heo-font-mono: "LXGW WenKai Mono", ui-monospace, SFMono-Regular, "SF Mono", Menlo, Monaco,
            ...
            --heo-article-surface-max-width-focus: 64rem;
        ...
        #theme-heo #post-info .post-info-inner {
            ...
            gap: clamp(0.8rem, 1.7vw, 1.08rem);
            min-height: inherit;
        }
        ...
        #theme-heo #post-info .post-info-title-zone {
            ...
            align-items: flex-start;
            width: 100%;
            min-height: clamp(5.2rem, 7.6vw, 7rem);
            overflow: visible;
        }
        ...
        #theme-heo #post-info .post-info-meta-item {
            display: inline-flex;
            align-items: center;
            min-height: 1.4rem;
            padding: 0;
        ...
        #theme-heo #post-info .post-info-meta-item i,
        #theme-heo #post-info .post-info-meta-item svg {
            color: rgba(255, 255, 255, 0.48);
        }

        #theme-heo #post-info .post-info-meta-item--link {
            transition: color var(--heo-dur-fast) var(--heo-ease), opacity var(--heo-dur-fast) var(--heo-ease);
        }

        #theme-heo #post-info .post-info-meta-item--link:hover {
            color: rgba(255, 255, 255, 0.9);
            opacity: 1;
        }

        html.dark #theme-heo #post-info .post-info-meta {
            color: rgba(226, 232, 240, 0.66);
        }

        html.dark #theme-heo #post-info .post-info-meta-item i,
        html.dark #theme-heo #post-info .post-info-meta-item svg {
        ...
        @media (min-width: 768px) {
            ...
            #theme-heo #post-bg-content {
                padding-bottom: clamp(2.9rem, 4vw, 4.2rem);
            }

            #theme-heo #post-info {
                min-height: clamp(9.6rem, 13.2vw, 11.4rem);
            }
            ...
            #theme-heo #post-info .post-info-title-zone {
                min-height: clamp(4.8rem, 6.6vw, 6.2rem);
            }
        ...
        .heo-float-toc-anchor--portal {
            bottom: max(6.95rem, calc(env(safe-area-inset-bottom, 0px) + 5.8rem));
            opacity: 0.9;
            transform: translate3d(0, 0, 0);
            transition: opacity var(--heo-dur-fast) var(--heo-ease), transform var(--heo-dur-fast) var(--heo-ease), bottom var(--heo-dur-fast) var(--heo-ease);
        }

        .heo-float-toc-anchor--portal.is-active {
            bottom: max(8rem, calc(env(safe-area-inset-bottom, 0px) + 6.7rem));
        }

        .heo-float-toc-anchor--portal.is-scrolling {
            opacity: 0.5;
            transform: translate3d(0, 0.3rem, 0) scale(0.96);
        }

        .heo-float-toc-anchor--portal .heo-float-widget-btn--portal {
            position: relative;
            display: inline-flex;
            align-items: center;
            justify-content: center;
            ...
            color: #334155;
            box-shadow: 0 18px 34px rgba(15, 23, 42, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.82);
            -webkit-backdrop-filter: saturate(180%) blur(16px);
            backdrop-filter: saturate(180%) blur(16px);
            transition: transform var(--heo-dur-fast) var(--heo-ease), border-color var(--heo-dur-fast) var(--heo-ease), background var(--heo-dur-fast) var(--heo-ease), color var(--heo-dur-fast) var(--heo-ease), box-shadow var(--heo-dur-fast) var(--heo-ease), opacity var(--heo-dur-fast) var(--heo-ease);
        }

        .heo-float-toc-anchor--portal .heo-float-widget-btn--portal .heo-float-widget-btn__icon {
            font-size: 0.82rem;
            line-height: 1;
        }

        .heo-float-toc-anchor--portal .heo-float-widget-btn--portal .heo-float-widget-btn__meta {
            font-size: 0.68rem;
            line-height: 1;
            font-weight: 700;
            color: #475569;
        ...
        html.dark .heo-float-toc-anchor--portal .heo-float-widget-btn--portal .heo-float-widget-btn__icon-wrap {
            background: rgba(245, 158, 11, 0.14);
        }

        html.dark .heo-float-toc-anchor--portal .heo-float-widget-btn--portal .heo-float-widget-btn__meta {
            color: #e2e8f0;
        }


        @media (hover: hover) {
            .heo-float-toc-anchor--portal .heo-float-widget-btn--portal:hover {
                transform: translateY(-1px);
            ...
            html.dark .heo-float-toc-anchor--portal .heo-float-widget-btn--portal:hover .heo-float-widget-btn__icon-wrap {
                background: rgba(245, 158, 11, 0.18);
            }

        }

        .heo-float-toc-anchor--portal .heo-float-widget-btn--portal:focus-visible {
            outline: none;
            border-color: rgba(59, 130, 246, 0.72);
            box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.16), 0 16px 30px rgba(15, 23, 42, 0.12);
        }

        html.dark .heo-float-toc-anchor--portal .heo-float-widget-btn--portal:focus-visible {
            border-color: rgba(245, 158, 11, 0.28);
        ...
        @media (max-width: 430px) {
            .heo-float-toc-anchor--portal {
                right: 0.85rem;
                bottom: max(6.2rem, calc(env(safe-area-inset-bottom, 0px) + 5.15rem));
            }

            .heo-float-toc-anchor--portal.is-active {
                bottom: max(7.25rem, calc(env(safe-area-inset-bottom, 0px) + 6rem));
            }
        }
        ...
        #theme-heo .heo-float-toc-anchor {
            bottom: max(6.15rem, calc(env(safe-area-inset-bottom, 0px) + 5rem));
            opacity: 0.9;
            transform: translate3d(0, 0, 0);
            transition: opacity var(--heo-dur-fast) var(--heo-ease), transform var(--heo-dur-fast) var(--heo-ease), bottom var(--heo-dur-fast) var(--heo-ease);
        }

        #theme-heo .heo-float-toc-anchor.is-active {
            bottom: max(7.2rem, calc(env(safe-area-inset-bottom, 0px) + 6rem));
        }

        #theme-heo .heo-float-toc-anchor.is-scrolling {
            opacity: 0.5;
            transform: translate3d(0, 0.3rem, 0) scale(0.96);
        }

        #theme-heo .heo-float-toc-anchor .heo-float-widget-btn {
            box-shadow: 0 18px 34px rgba(15, 23, 42, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.82);
        }
        ...
        @media (max-width: 430px) {
            #theme-heo .heo-float-toc-anchor {
                right: 0.85rem;
                bottom: max(5.65rem, calc(env(safe-area-inset-bottom, 0px) + 4.6rem));
            }

            #theme-heo .heo-float-toc-anchor.is-active {
                bottom: max(6.6rem, calc(env(safe-area-inset-bottom, 0px) + 5.4rem));
            }
        }
        ...
        #theme-heo .heo-hero-slider__stage::after,
        #theme-heo .heo-mobile-hero__slide::after,
        #theme-heo .heo-mobile-reading-entry::after {
            content: '';
            position: absolute;
        ...
        #theme-heo .heo-hero-slider__stage::after {
            animation: heo-hero-sheen 15s cubic-bezier(0.22, 1, 0.36, 1) infinite;
            animation-delay: 1.2s;
        }

        #theme-heo .heo-mobile-hero__slide::after {
            animation: heo-hero-sheen 18s cubic-bezier(0.22, 1, 0.36, 1) infinite;
            animation-delay: 2.1s;
        }

        #theme-heo .heo-mobile-reading-entry::after {
            animation: heo-hero-sheen 20s cubic-bezier(0.22, 1, 0.36, 1) infinite;
        ...
        #theme-heo[data-heo-season="spring"] .heo-hero-slider::before {
            background: radial-gradient(circle at 18% 18%, rgba(244, 163, 189, 0.18), transparent 42%);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-slider__overlay {
            background:
                linear-gradient(180deg, rgba(15, 23, 42, 0.12) 0%, rgba(15, 23, 42, 0.52) 54%, rgba(15, 23, 42, 0.84) 100%),
                linear-gradient(135deg, rgba(190, 24, 93, 0.18), rgba(22, 163, 74, 0.08));
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-slider__badge,
        #theme-heo[data-heo-season="spring"] .heo-hero-books__eyebrow {
            border-color: rgba(251, 207, 232, 0.34);
            background: rgba(136, 19, 55, 0.26);
            color: rgba(255, 247, 250, 0.98);
            box-shadow: 0 10px 24px rgba(136, 19, 55, 0.18);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-slider__thumb-index {
            color: rgba(219, 39, 119, 0.72);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-slider__thumb:hover,
        #theme-heo[data-heo-season="spring"] .heo-hero-slider__thumb.is-active {
            border-color: rgba(244, 163, 189, 0.28);
            box-shadow: 0 14px 28px rgba(244, 163, 189, 0.12);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(244, 163, 189, 0.18), transparent 34%),
                linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(244, 255, 249, 0.94)) !important;
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-books__link {
            border-color: rgba(244, 163, 189, 0.18);
            background: rgba(255, 246, 250, 0.86);
            color: rgba(190, 24, 93, 0.92);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-books__item {
            background: rgba(255, 252, 253, 0.88);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-books__item:hover {
            border-color: rgba(244, 163, 189, 0.24);
            box-shadow: 0 16px 32px rgba(244, 163, 189, 0.1);
        }

        #theme-heo[data-heo-season="spring"] .heo-hero-books__cover-wrap {
            box-shadow: 0 16px 28px rgba(244, 163, 189, 0.16);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-slider::before {
            background: radial-gradient(circle at 78% 20%, rgba(34, 211, 238, 0.26), transparent 46%);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-slider__overlay {
            background:
                linear-gradient(180deg, rgba(8, 47, 73, 0.08) 0%, rgba(15, 23, 42, 0.44) 58%, rgba(15, 23, 42, 0.84) 100%),
                linear-gradient(135deg, rgba(34, 211, 238, 0.24), rgba(250, 204, 21, 0.12));
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-slider__badge,
        #theme-heo[data-heo-season="summer"] .heo-hero-books__eyebrow {
            border-color: rgba(125, 211, 252, 0.26);
            background: rgba(8, 47, 73, 0.22);
            color: rgba(224, 242, 254, 0.96);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-slider__thumb-index {
            color: rgba(8, 145, 178, 0.78);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-slider__thumb:hover,
        #theme-heo[data-heo-season="summer"] .heo-hero-slider__thumb.is-active {
            border-color: rgba(34, 211, 238, 0.24);
            box-shadow: 0 14px 28px rgba(34, 211, 238, 0.12);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(34, 211, 238, 0.16), transparent 34%),
                linear-gradient(180deg, rgba(248, 253, 255, 0.98), rgba(240, 249, 255, 0.94)) !important;
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-books__link {
            border-color: rgba(34, 211, 238, 0.18);
            background: rgba(240, 253, 250, 0.9);
            color: rgba(14, 116, 144, 0.92);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-books__item {
            background: rgba(247, 254, 255, 0.9);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-books__item:hover {
            border-color: rgba(34, 211, 238, 0.22);
            box-shadow: 0 16px 32px rgba(34, 211, 238, 0.1);
        }

        #theme-heo[data-heo-season="summer"] .heo-hero-books__cover-wrap {
            box-shadow: 0 16px 28px rgba(34, 211, 238, 0.16);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-slider::before {
            background: radial-gradient(circle at 82% 18%, rgba(249, 115, 22, 0.28), transparent 46%);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-slider__overlay {
            background:
                linear-gradient(180deg, rgba(120, 53, 15, 0.08) 0%, rgba(15, 23, 42, 0.44) 58%, rgba(15, 23, 42, 0.84) 100%),
                linear-gradient(135deg, rgba(249, 115, 22, 0.24), rgba(251, 191, 36, 0.14));
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-slider__badge,
        #theme-heo[data-heo-season="autumn"] .heo-hero-books__eyebrow {
            border-color: rgba(251, 191, 36, 0.26);
            background: rgba(154, 52, 18, 0.18);
            color: rgba(255, 237, 213, 0.96);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-slider__thumb-index {
            color: rgba(194, 65, 12, 0.76);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-slider__thumb:hover,
        #theme-heo[data-heo-season="autumn"] .heo-hero-slider__thumb.is-active {
            border-color: rgba(249, 115, 22, 0.24);
            box-shadow: 0 14px 28px rgba(249, 115, 22, 0.12);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(249, 115, 22, 0.16), transparent 34%),
                linear-gradient(180deg, rgba(255, 251, 235, 0.98), rgba(255, 247, 237, 0.94)) !important;
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-books__link {
            border-color: rgba(249, 115, 22, 0.18);
            background: rgba(255, 247, 237, 0.92);
            color: rgba(194, 65, 12, 0.94);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-books__item {
            background: rgba(255, 251, 245, 0.9);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-books__item:hover {
            border-color: rgba(249, 115, 22, 0.22);
            box-shadow: 0 16px 32px rgba(249, 115, 22, 0.1);
        }

        #theme-heo[data-heo-season="autumn"] .heo-hero-books__cover-wrap {
            box-shadow: 0 16px 28px rgba(249, 115, 22, 0.18);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-slider::before {
            background: radial-gradient(circle at 20% 16%, rgba(191, 219, 254, 0.26), transparent 48%);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-slider__overlay {
            background:
                linear-gradient(180deg, rgba(148, 163, 184, 0.08) 0%, rgba(15, 23, 42, 0.42) 56%, rgba(15, 23, 42, 0.82) 100%),
                linear-gradient(135deg, rgba(191, 219, 254, 0.26), rgba(125, 211, 252, 0.1));
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-slider__badge,
        #theme-heo[data-heo-season="winter"] .heo-hero-books__eyebrow {
            border-color: rgba(191, 219, 254, 0.28);
            background: rgba(239, 246, 255, 0.18);
            color: rgba(239, 246, 255, 0.98);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-slider__thumb-index {
            color: rgba(71, 85, 105, 0.76);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-slider__thumb:hover,
        #theme-heo[data-heo-season="winter"] .heo-hero-slider__thumb.is-active {
            border-color: rgba(148, 163, 184, 0.26);
            box-shadow: 0 14px 28px rgba(148, 163, 184, 0.12);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(191, 219, 254, 0.16), transparent 34%),
                linear-gradient(180deg, rgba(248, 250, 252, 0.98), rgba(241, 245, 249, 0.94)) !important;
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-books__link {
            border-color: rgba(191, 219, 254, 0.22);
            background: rgba(248, 250, 252, 0.92);
            color: rgba(51, 65, 85, 0.92);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-books__item {
            background: rgba(248, 250, 252, 0.9);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-books__item:hover {
            border-color: rgba(148, 163, 184, 0.22);
            box-shadow: 0 16px 32px rgba(148, 163, 184, 0.1);
        }

        #theme-heo[data-heo-season="winter"] .heo-hero-books__cover-wrap {
            box-shadow: 0 16px 28px rgba(148, 163, 184, 0.16);
        }

        html.dark #theme-heo[data-heo-season="spring"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(244, 163, 189, 0.16), transparent 34%),
                linear-gradient(180deg, rgba(15, 23, 42, 0.9), rgba(20, 33, 29, 0.82)) !important;
        }

        html.dark #theme-heo[data-heo-season="summer"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(34, 211, 238, 0.16), transparent 34%),
                linear-gradient(180deg, rgba(15, 23, 42, 0.9), rgba(8, 47, 73, 0.8)) !important;
        }

        html.dark #theme-heo[data-heo-season="autumn"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(249, 115, 22, 0.18), transparent 34%),
                linear-gradient(180deg, rgba(28, 25, 23, 0.92), rgba(68, 64, 60, 0.82)) !important;
        }

        html.dark #theme-heo[data-heo-season="winter"] .heo-hero-books {
            background:
                radial-gradient(circle at top right, rgba(191, 219, 254, 0.16), transparent 34%),
                linear-gradient(180deg, rgba(15, 23, 42, 0.9), rgba(30, 41, 59, 0.82)) !important;
        }

        html.dark #theme-heo[data-heo-season="spring"] .heo-hero-slider__thumb:hover,
        html.dark #theme-heo[data-heo-season="spring"] .heo-hero-slider__thumb.is-active,
        html.dark #theme-heo[data-heo-season="summer"] .heo-hero-slider__thumb:hover,
        html.dark #theme-heo[data-heo-season="summer"] .heo-hero-slider__thumb.is-active,
        html.dark #theme-heo[data-heo-season="autumn"] .heo-hero-slider__thumb:hover,
        html.dark #theme-heo[data-heo-season="autumn"] .heo-hero-slider__thumb.is-active,
        html.dark #theme-heo[data-heo-season="winter"] .heo-hero-slider__thumb:hover,
        html.dark #theme-heo[data-heo-season="winter"] .heo-hero-slider__thumb.is-active {
            background: rgba(30, 41, 59, 0.82);
        }

        html.dark #theme-heo[data-heo-season="spring"] .heo-hero-books__item:hover {
            border-color: rgba(244, 163, 189, 0.26);
        }

        html.dark #theme-heo[data-heo-season="summer"] .heo-hero-books__item:hover {
            border-color: rgba(34, 211, 238, 0.24);
        }

        html.dark #theme-heo[data-heo-season="autumn"] .heo-hero-books__item:hover {
            border-color: rgba(249, 115, 22, 0.26);
        }

        html.dark #theme-heo[data-heo-season="winter"] .heo-hero-books__item:hover {
            border-color: rgba(191, 219, 254, 0.24);
        }

        @media (max-width: 1279px) {
            #theme-heo[data-heo-season="spring"] .heo-mobile-hero__slide {
                border-color: rgba(251, 207, 232, 0.42);
                box-shadow: 0 18px 42px rgba(190, 24, 93, 0.14);
            }

            #theme-heo[data-heo-season="spring"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(255, 251, 253, 0.96), rgba(247, 252, 249, 0.92)) !important;
            }

            #theme-heo[data-heo-season="spring"] .heo-mobile-reading-entry__eyebrow,
            #theme-heo[data-heo-season="spring"] .heo-mobile-hero__slide-badge {
                border-color: rgba(251, 207, 232, 0.34);
                background: rgba(136, 19, 55, 0.26);
                color: rgba(255, 247, 250, 0.98);
                box-shadow: 0 10px 24px rgba(136, 19, 55, 0.16);
            }

            #theme-heo[data-heo-season="spring"] .heo-mobile-reading-entry__link {
                border-color: rgba(244, 163, 189, 0.22);
                background: rgba(255, 245, 249, 0.92);
                color: rgba(157, 23, 77, 0.94);
            }

            #theme-heo[data-heo-season="spring"] .heo-mobile-reading-entry__cover-link {
                box-shadow: 0 14px 26px rgba(244, 163, 189, 0.18);
            }

            #theme-heo[data-heo-season="summer"] .heo-mobile-hero__slide {
                border-color: rgba(224, 242, 254, 0.42);
                box-shadow: 0 18px 42px rgba(34, 211, 238, 0.16);
            }

            #theme-heo[data-heo-season="summer"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(247, 254, 255, 0.96), rgba(240, 253, 250, 0.92)) !important;
            }

            #theme-heo[data-heo-season="summer"] .heo-mobile-reading-entry__eyebrow,
            #theme-heo[data-heo-season="summer"] .heo-mobile-hero__slide-badge {
                border-color: rgba(125, 211, 252, 0.26);
                background: rgba(8, 47, 73, 0.22);
                color: rgba(224, 242, 254, 0.96);
            }

            #theme-heo[data-heo-season="summer"] .heo-mobile-reading-entry__link {
                border-color: rgba(34, 211, 238, 0.18);
                background: rgba(240, 253, 250, 0.9);
                color: rgba(14, 116, 144, 0.92);
            }

            #theme-heo[data-heo-season="summer"] .heo-mobile-reading-entry__cover-link {
                box-shadow: 0 14px 26px rgba(34, 211, 238, 0.18);
            }

            #theme-heo[data-heo-season="autumn"] .heo-mobile-hero__slide {
                border-color: rgba(255, 237, 213, 0.44);
                box-shadow: 0 18px 42px rgba(249, 115, 22, 0.16);
            }

            #theme-heo[data-heo-season="autumn"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(255, 251, 245, 0.96), rgba(255, 247, 237, 0.92)) !important;
            }

            #theme-heo[data-heo-season="autumn"] .heo-mobile-reading-entry__eyebrow,
            #theme-heo[data-heo-season="autumn"] .heo-mobile-hero__slide-badge {
                border-color: rgba(251, 191, 36, 0.24);
                background: rgba(154, 52, 18, 0.18);
                color: rgba(255, 237, 213, 0.96);
            }

            #theme-heo[data-heo-season="autumn"] .heo-mobile-reading-entry__link {
                border-color: rgba(249, 115, 22, 0.18);
                background: rgba(255, 247, 237, 0.92);
                color: rgba(194, 65, 12, 0.94);
            }

            #theme-heo[data-heo-season="autumn"] .heo-mobile-reading-entry__cover-link {
                box-shadow: 0 14px 26px rgba(249, 115, 22, 0.18);
            }

            #theme-heo[data-heo-season="winter"] .heo-mobile-hero__slide {
                border-color: rgba(239, 246, 255, 0.44);
                box-shadow: 0 18px 42px rgba(148, 163, 184, 0.16);
            }

            #theme-heo[data-heo-season="winter"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(248, 250, 252, 0.96), rgba(241, 245, 249, 0.92)) !important;
            }

            #theme-heo[data-heo-season="winter"] .heo-mobile-reading-entry__eyebrow,
            #theme-heo[data-heo-season="winter"] .heo-mobile-hero__slide-badge {
                border-color: rgba(191, 219, 254, 0.26);
                background: rgba(239, 246, 255, 0.18);
                color: rgba(239, 246, 255, 0.98);
            }

            #theme-heo[data-heo-season="winter"] .heo-mobile-reading-entry__link {
                border-color: rgba(191, 219, 254, 0.22);
                background: rgba(248, 250, 252, 0.92);
                color: rgba(51, 65, 85, 0.92);
            }

            #theme-heo[data-heo-season="winter"] .heo-mobile-reading-entry__cover-link {
                box-shadow: 0 14px 26px rgba(148, 163, 184, 0.16);
            }

            html.dark #theme-heo[data-heo-season="spring"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(30, 41, 59, 0.86), rgba(20, 33, 29, 0.84)) !important;
            }

            html.dark #theme-heo[data-heo-season="summer"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(15, 23, 42, 0.88), rgba(8, 47, 73, 0.82)) !important;
            }

            html.dark #theme-heo[data-heo-season="autumn"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(28, 25, 23, 0.9), rgba(68, 64, 60, 0.84)) !important;
            }

            html.dark #theme-heo[data-heo-season="winter"] .heo-mobile-reading-entry {
                background: linear-gradient(135deg, rgba(15, 23, 42, 0.9), rgba(30, 41, 59, 0.84)) !important;
            }
        }
        ...
        * {
        ...
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-header-action-group,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat #nav-bar-swipe nav#nav-mobile.heo-nav-menu {
        ...
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat a,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat button,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__link,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__trigger,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-brand-mark,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-brand-mark__text,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__label,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__icon,
        #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__chevron {
            color: rgba(15, 23, 42, 0.92) !important;
        }

        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-top-nav__brand,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-header-action-group,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat #nav-bar-swipe nav#nav-mobile.heo-nav-menu {
            border-color: rgba(255, 255, 255, 0.1) !important;
            background: rgba(7, 10, 18, 0.7) !important;
            box-shadow: 0 14px 34px rgba(0, 0, 0, 0.28) !important;
        }

        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat a,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat button,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__link,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__trigger,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-brand-mark,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-brand-mark__text,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__label,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__icon,
        html.dark #theme-heo nav#nav.heo-top-nav.heo-top-nav--post.heo-top-nav--flat .heo-nav-menu__chevron {
        ...
        #theme-heo #article-wrapper .heo-article-content-width {
            width: 100%;
            max-width: var(--heo-article-surface-max-width);
            margin: 0 auto;
        }

        #theme-heo #article-wrapper .heo-article-toolbar {
            display: flex;
            align-items: center;
            justify-content: flex-end;
        ...
        #theme-heo #article-wrapper .heo-article-toolbar.is-focus-reading {
            margin-bottom: 0.32rem;
        }

        #theme-heo #article-wrapper .heo-article-toolbar__actions {
            display: flex;
            align-items: center;
            justify-content: flex-end;
            gap: 0.46rem;
        ...
        @media (min-width: 1024px) {
            ...
            #theme-heo #article-wrapper .heo-article-focus-toc-btn {
                ...
                background: rgba(255, 255, 255, 0.72);
                color: #475569;
                box-shadow: 0 8px 20px rgba(15, 23, 42, 0.06), inset 0 1px 0 rgba(255, 255, 255, 0.72);
            ...
            #theme-heo #article-wrapper .heo-article-focus-toc-btn:hover {
                ...
                color: #334155;
                box-shadow: 0 10px 24px rgba(15, 23, 42, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.78);
            }

            #theme-heo #article-wrapper .heo-article-focus-toggle:focus-visible,
            #theme-heo #article-wrapper .heo-article-focus-toc-btn:focus-visible {
                outline: none;
                border-color: rgba(59, 130, 246, 0.52);
                box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.12), 0 10px 24px rgba(59, 130, 246, 0.08);
            }

            #theme-heo #article-wrapper .heo-article-focus-toggle.is-active,
            #theme-heo #article-wrapper .heo-article-focus-toc-btn {
                background: rgba(239, 246, 255, 0.82);
                border-color: rgba(147, 197, 253, 0.72);
                color: #2563eb;
                box-shadow: 0 10px 24px rgba(37, 99, 235, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.76);
            }

            #theme-heo #article-wrapper .heo-article-focus-toggle__icon,
            #theme-heo #article-wrapper .heo-article-focus-toc-btn__icon {
                width: 1.28rem;
                height: 1.28rem;
                display: inline-flex;
                align-items: center;
            ...
            #theme-heo #article-wrapper .heo-article-focus-toggle__text,
            #theme-heo #article-wrapper .heo-article-focus-toc-btn__text {
                font-size: 0.76rem;
                font-weight: 600;
                letter-spacing: 0.01em;
                white-space: nowrap;
            ...
            html.dark #theme-heo #article-wrapper .heo-article-focus-toggle,
            html.dark #theme-heo #article-wrapper .heo-article-focus-toc-btn {
            ...
            html.dark #theme-heo #article-wrapper .heo-article-focus-toggle:hover,
            html.dark #theme-heo #article-wrapper .heo-article-focus-toc-btn:hover {
            ...
            html.dark #theme-heo #article-wrapper .heo-article-focus-toggle:focus-visible,
            html.dark #theme-heo #article-wrapper .heo-article-focus-toc-btn:focus-visible {
                border-color: rgba(250, 204, 21, 0.26);
                box-shadow: 0 0 0 3px rgba(250, 204, 21, 0.12), 0 12px 28px rgba(0, 0, 0, 0.22);
            }

            html.dark #theme-heo #article-wrapper .heo-article-focus-toggle.is-active,
            html.dark #theme-heo #article-wrapper .heo-article-focus-toc-btn {
            ...
            html.dark #theme-heo #article-wrapper .heo-article-focus-toggle__icon,
            html.dark #theme-heo #article-wrapper .heo-article-focus-toc-btn__icon {
        ...
        @media (min-width: 1024px) {
            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] {
                width: min(100%, 100%) !important;
                max-width: 100% !important;
                margin-top: calc(4rem + env(safe-area-inset-top, 0px) + 0.9rem);
                box-shadow: 0 20px 56px rgba(15, 23, 42, 0.08);
            }

            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] .heo-post-shell__inner {
                max-width: min(100%, 82rem);
            }

            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] #article-wrapper #notion-article.heo-article-body,
            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] #article-wrapper .heo-article-content-width {
                max-width: var(--heo-article-surface-max-width-focus);
            }

            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] #article-wrapper .heo-focus-reading-intro {
                margin-bottom: 0.52rem;
            }

            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] #article-wrapper .heo-article-reading-shell {
                padding-top: 0.35rem;
            }

            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] #article-wrapper .heo-article-section {
                padding-top: 1.2rem;
            }

            #theme-heo .heo-focus-toc-drawer__panel {
                max-width: 23rem;
            }

            html.dark #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] {
        ...
        @media (max-width: 1023px) {
            #theme-heo #wrapper-outer .article.heo-post-shell[data-heo-focus-reading='true'] {
                margin-top: calc(4rem + env(safe-area-inset-top, 0px) + 0.45rem);
            }
        }
        ...
        #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row {
            margin: 0.08rem 0 calc(var(--heo-article-block-gap) + 0.12rem);
            padding: 0.22rem;
            border-radius: 0.92rem;
            background: linear-gradient(180deg, rgba(255, 255, 255, 0.52), rgba(248, 250, 252, 0.34));
            border: 1px solid rgba(203, 213, 225, 0.28);
            box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.42), 0 4px 12px rgba(15, 23, 42, 0.025);
            display: flex;
            flex-wrap: wrap;
            align-items: flex-start;
            gap: var(--heo-gallery-gap, 0.45rem);
        }

        html.dark #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row {
            background: linear-gradient(180deg, rgba(15, 23, 42, 0.42), rgba(17, 24, 39, 0.28));
        ...
        @media (min-width: 768px) {
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row {
                ...
                padding: 0.3rem;
                border-radius: 1.12rem;
                background: linear-gradient(180deg, rgba(255, 255, 255, 0.48), rgba(248, 250, 252, 0.3));
                border-color: rgba(203, 213, 225, 0.26);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.42), 0 6px 16px rgba(15, 23, 42, 0.025);
            }

            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"] {
                --heo-gallery-gap: 0.68rem;
                padding: 0.24rem;
                border-radius: 1.1rem;
                align-items: stretch;
                background: linear-gradient(180deg, rgba(255, 255, 255, 0.4), rgba(248, 250, 252, 0.24));
                border-color: rgba(203, 213, 225, 0.22);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.38), 0 5px 14px rgba(15, 23, 42, 0.02);
            }

            html.dark #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"] {
                background: linear-gradient(180deg, rgba(15, 23, 42, 0.38), rgba(17, 24, 39, 0.24));
                border-color: rgba(255, 255, 255, 0.04);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.025), 0 10px 22px rgba(0, 0, 0, 0.1);
            }
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"][data-heo-gallery-stacked-column="left"] > .notion-column:first-child {
                flex: 0 0 calc(41.5% - (var(--heo-gallery-gap, 0.72rem) / 2)) !important;
                width: calc(41.5% - (var(--heo-gallery-gap, 0.72rem) / 2)) !important;
                gap: 0.34rem;
            }
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"][data-heo-gallery-stacked-column="left"] > .notion-column:last-child {
                flex: 0 0 calc(58.5% - (var(--heo-gallery-gap, 0.72rem) / 2)) !important;
                width: calc(58.5% - (var(--heo-gallery-gap, 0.72rem) / 2)) !important;
            }
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"] > .notion-column .notion-asset-caption {
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"][data-heo-gallery-stacked-column="right"] > .notion-column:last-child .notion-asset-wrapper-image {
                ...
                box-shadow: 0 6px 14px rgba(15, 23, 42, 0.032), 0 1px 2px rgba(15, 23, 42, 0.018);
            }
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"][data-heo-gallery-stacked-column="right"] > .notion-column:first-child .notion-asset-wrapper-image {
                aspect-ratio: 4 / 5.2;
                border-radius: 1rem;
                box-shadow: 0 8px 18px rgba(15, 23, 42, 0.04), 0 1px 2px rgba(15, 23, 42, 0.02);
            }
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"] > .notion-column:first-child .notion-asset-caption,
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"] > .notion-column:last-child .notion-asset-caption {
                padding-left: 0.12rem;
                padding-right: 0.12rem;
            }

            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-count="2"] {
                --heo-gallery-gap: 0.84rem;
                padding: 0.34rem;
                border-radius: 1.2rem;
            }

            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-count="2"] > .notion-column {
                flex-basis: calc((100% - var(--heo-gallery-gap, 0.84rem)) / 2) !important;
                width: calc((100% - var(--heo-gallery-gap, 0.84rem)) / 2) !important;
                display: flex;
                flex-direction: column;
                justify-content: flex-start;
                align-self: flex-start;
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-count="6"] > .notion-column .notion-asset-wrapper-image {
                ...
                box-shadow: 0 5px 12px rgba(15, 23, 42, 0.032), 0 1px 2px rgba(15, 23, 42, 0.018);
            }
        ...
        #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row > .notion-column .notion-asset-wrapper-image {
            ...
            box-shadow: 0 6px 14px rgba(15, 23, 42, 0.032), 0 1px 2px rgba(15, 23, 42, 0.02);
        }
        ...
        html.dark #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-count="2"] > .notion-column .notion-asset-wrapper-image {
            box-shadow: 0 10px 22px rgba(0, 0, 0, 0.16), 0 1px 3px rgba(0, 0, 0, 0.06);
        }
        ...
        #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row > .notion-column .notion-asset-wrapper-image:hover {
            ...
            box-shadow: 0 8px 18px rgba(15, 23, 42, 0.04), 0 1px 3px rgba(15, 23, 42, 0.025);
        }
        ...
        html.dark #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row > .notion-column .notion-asset-wrapper-image:hover {
            ...
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.18), 0 2px 4px rgba(0, 0, 0, 0.08);
        }
        ...
        @media (max-width: 767px) {
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row {
                ...
                margin: 0.08rem 0 calc(var(--heo-article-block-gap) + 0.05rem);
                padding: 0.18rem;
                gap: var(--heo-gallery-gap, 0.34rem);
                border-radius: 0.9rem;
                background: linear-gradient(180deg, rgba(255, 255, 255, 0.44), rgba(248, 250, 252, 0.24));
                border-color: rgba(203, 213, 225, 0.22);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.36), 0 4px 12px rgba(15, 23, 42, 0.025);
            }

            html.dark #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row {
                background: linear-gradient(180deg, rgba(15, 23, 42, 0.38), rgba(17, 24, 39, 0.22));
                border-color: rgba(255, 255, 255, 0.04);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.02), 0 8px 18px rgba(0, 0, 0, 0.1);
            }

            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"] {
                --heo-gallery-gap: 0.28rem;
            }

            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"][data-heo-gallery-stacked-column="left"] > .notion-column:first-child {
                width: calc(40% - (var(--heo-gallery-gap, 0.28rem) / 2)) !important;
                flex: 0 0 calc(40% - (var(--heo-gallery-gap, 0.28rem) / 2)) !important;
                gap: 0.2rem;
            }

            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row[data-heo-gallery-pattern="mixed-stack"][data-heo-gallery-stacked-column="left"] > .notion-column:last-child {
                width: calc(60% - (var(--heo-gallery-gap, 0.28rem) / 2)) !important;
                flex: 0 0 calc(60% - (var(--heo-gallery-gap, 0.28rem) / 2)) !important;
            }
            ...
            #theme-heo #article-wrapper #notion-article .notion-row.heo-image-gallery-row > .notion-column .notion-asset-wrapper-image {
                ...
                box-shadow: 0 5px 12px rgba(15, 23, 42, 0.04), 0 1px 2px rgba(15, 23, 42, 0.02);
            }
