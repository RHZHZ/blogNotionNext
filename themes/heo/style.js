        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            #theme-heo #wrapper-outer .article {
                ...
                border-radius: var(--heo-radius-md) !important;
            }
            ...
            #theme-heo #article-wrapper #notion-article > .notion-simple-table,
            #theme-heo #article-wrapper #notion-article > .notion-callout,
            #theme-heo #article-wrapper #notion-article > .notion-bookmark,
            #theme-heo #article-wrapper #notion-article > .notion-audio,
            #theme-heo #article-wrapper #notion-article > .notion-equation-block,
            #theme-heo #article-wrapper #notion-article > .notion-toggle,
            #theme-heo #article-wrapper #notion-article > .notion-asset-wrapper-image {
            ...
            #theme-heo .notion-code::before {
                ...
                height: 10px !important;
                box-shadow: 18px 0 0 #ffbd2e, 36px 0 0 #28ca42 !important;
            }
            ...
            /* 任务列表文本优化 */
            #theme-heo .notion-to-do-item > div {
                font-size: 0.95em !important;
                line-height: 1.5 !important;
            }
