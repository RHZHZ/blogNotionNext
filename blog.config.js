...
const BLOG = {
  ...
  IMAGE_PROXY_ALLOW_HOSTS: (process.env.IMAGE_PROXY_ALLOW_HOSTS || 'www.notion.so,prod-files-secure.s3.us-west-2.amazonaws.com,s3.us-west-2.amazonaws.com,images.unsplash.com,s41.ax1x.com')
    .split(',')
    .map(s => s.trim())
    .filter(Boolean),
